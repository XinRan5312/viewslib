 ...
 */
public class CustomHeartContainer extends RelativeLayout {
    private Context context;

    private int width = 0;
    private int height = 0;

    private int[] colors = {Color.RED, Color.YELLOW, Color.GRAY, Color.GREEN, Color.BLUE, Color.CYAN, Color.LTGRAY};

    public CustomHeartContainer(Context context) {
        this(context, null);

    }

    public CustomHeartContainer(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomHeartContainer(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void addHeart() {
        ...
        final CustomHeartImage imageView = new CustomHeartImage(context);
        imageView.changeBgColor(colors[new Random().nextInt(colors.length)]);
