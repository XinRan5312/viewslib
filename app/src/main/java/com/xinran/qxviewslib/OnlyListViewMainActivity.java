...
public class OnlyListViewMainActivity extends AppCompatActivity implements QxListViewContainer.OnHeaderRefreshListener,
        QxListViewContainer.OnFooterRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listviewOne = (QxListView) findViewById(R.id.list_view);
    ...
    public void onFooterRefresh(QxBaseListViewContainer view) {
        mQxListViewContainer.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Toast.makeText(OnlyListViewMainActivity.this, "加载更多数据!", Toast.LENGTH_SHORT).show();
            }
    ...
    public void onHeaderRefresh(QxBaseListViewContainer view) {
        mQxListViewContainer.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Toast.makeText(OnlyListViewMainActivity.this, "数据刷新完成!", Toast.LENGTH_SHORT).show();
            }
